  ...
  return (
    <div className="bg-white">
      <div className="font-[sans-serif]  ">
        <div className="p-6 xl:w-full lg:max-w-7xl max-w-4xl mx-auto">
          <div className="grid items-start grid-cols-1 lg:grid-cols-5 gap-12  ">
            <div className="lg:col-span-3 w-full lg:sticky top-0 text-center">
              <div className="px-4 py-10  flex justify-center relative">
                <img
                ...
                {productDetails &&
                  productDetails.images.map((item: any, index: number) => (
                    <div
                      ...
                      className={`${
                        item == image
                          ? "border border-red-500 rounded-xl p-4 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]"
                          : "rounded-xl p-4 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]"
                      }  `}
